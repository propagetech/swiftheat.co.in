...
},
{
 ...
 "options": [
   ...
   ("Lead exit", [
     ("EA", "Axial", "Leads leave along the axis of the coil.", "", "co-exit-axial.png"),
     ("ER", "Radial", "Leads leave out of the side.", "", "co-exit-radial.png"),
...
},
{
 ...
 "options": [
   ("Profile", [
     ("F0", "Plain", "Flat case, for clamping to metal.", "", "strip-heaters-plain.png"),
     ("F1", "Finned", "Fins on the back, for heating air.", "", "strip-heaters-finned.png"),
   ]),
   ("Termination", [
     ("S1", "Screw terminals", "Exposed screw posts at one end.", "",
      "strip-heaters-terminals-and-mounting.png"),
     ("S3", "Flying leads", "Leads with the protection of your choice.", "",
      "strip-heaters-flying-leads.png"),
   ]),
 ],
...
#
# What the client marked up in docs/web 1.pptx, slot by slot. They screenshotted
# the preview and dropped a photograph onto each place they wanted one, so this
# maps their placements rather than our guesses: `hero` replaces the drawing
# beside the headline, `construction` and `selection` fill the two photograph
# required panels on the family page. A family absent from a slot keeps what it
...
#                        put it on this page themselves.
#
...
FAMILY_PHOTOS = {
 ...
 "thermocouples-and-sensors": {
   ...
   "construction_gallery": [
     ("thermocouples-probe-styles.png", 1254, 1254,
 ...
 "ceramic-infrared-heaters": {
   ...
   "hero": ("ceramic-infrared-heaters-hero.png", 1448, 1086,
...
FORMS = {
 "cartridge-heaters": [
   ...
   ("lead", "Lead protection", "select", ["L1 silicone coated fibreglass","L3 braided metal sleeve","L4 armour cable","L5 ceramic beading"]),
